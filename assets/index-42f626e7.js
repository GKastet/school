import{u as a,j as e,G as x,r as c,L as C}from"./index-07c04f88.js";import{P as n,I as d,a as p,T as S,b as P,B as R}from"./BtnUp-6e4a8dd0.js";const z=a.li`
  border-radius: 20px;
  /* box-shadow: none; */
...
`,j=({imageId:t,setImageId:i})=>{const r=()=>{if(t===4){alert("You achieved the last image");return}i(t+1)};return e.jsx(e.Fragment,{children:e.jsx(D,{type:"button",onClick:r,children:e.jsx(M,{})})})};j.propTypes={imageId:n.number.isRequired,setImageId:n.func.isRequired};const y=({onCloseModal:t,modal:i})=>{const{isOpen:r,modalData:s}=i,[o,b]=c.useState(Number(s.id));c.useEffect(()=>{if(!r)return;document.body.classList.add("no-scroll");const l=I=>{I.code==="Escape"&&(document.body.classList.remove("no-scroll"),t())};return window.addEventListener("keydown",l),()=>{window.removeEventListener("keydown",l)}},[r,t]);const k=l=>{l.target===l.currentTarget&&(document.body.classList.remove("no-scroll"),t())},B={id:o.toString()};return e.jsx(T,{onClick:k,children:e.jsxs("div",{style:{position:"relative"},children:[e.jsx(u,{data:B,isOpen:i.isOpen}),e.jsx(v,{onCloseModal:t}),e.jsx(w,{imageId:o,setImageId:b}),e.jsx(j,{imageId:o,setImageId:b})]})})};y.propTypes={onCloseModal:n.func.isRequired,modal:n.object.isRequired};const m=[{id:"1",imgSrc:"/school/src/images/50WebP.webp",imgAlt:"Project foto",projectName:"Project name"},{id:"2",imgSrc:"/school/src/images/64WebP.webp",imgAlt:"Project foto",projectName:"Project name"},{id:"3",imgSrc:"/school/src/images/50WebP.webp",imgAlt:"Project foto",projectName:"Project name"},{id:"4",imgSrc:"/school/src/images/64WebP.webp",imgAlt:"Project foto",projectName:"Project name"}],O=()=>{const[t,i]=c.useState({isOpen:!1,modalData:null}),r=o=>{i({isOpen:!0,modalData:o})},s=()=>i({isOpen:!1,modalData:null});return e.jsxs(e.Fragment,{children:[e.jsx(S,{children:"Galéria"}),e.jsx("ul",{style:{display:"flex",flexWrap:"wrap",justifyContent:"center",gap:"20px",paddingBottom:"20px"},children:m==null?void 0:m.map(o=>e.jsx(f,{data:o,onOpenModal:r},o.id))}),t.isOpen&&e.jsx(y,{onCloseModal:s,modal:t})]})};function W(t){return x({tag:"svg",attr:{version:"1.2",baseProfile:"tiny",viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M19.164 19.547c-1.641-2.5-3.669-3.285-6.164-3.484v1.437c0 .534-.208 1.036-.586 1.414-.756.756-2.077.751-2.823.005l-6.293-6.207c-.191-.189-.298-.444-.298-.713s.107-.524.298-.712l6.288-6.203c.754-.755 2.073-.756 2.829.001.377.378.585.88.585 1.414v1.704c4.619.933 8 4.997 8 9.796v1c0 .442-.29.832-.714.958-.095.027-.19.042-.286.042-.331 0-.646-.165-.836-.452zm-7.141-5.536c2.207.056 4.638.394 6.758 2.121-.768-3.216-3.477-5.702-6.893-6.08-.504-.056-.888-.052-.888-.052v-3.497l-5.576 5.496 5.576 5.5v-3.499l1.023.011z"}}]})(t)}const Y=a(C)`
width: 140px;
height: 60px;
padding: 5px;
display: flex;
